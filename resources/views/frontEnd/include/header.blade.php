<header class="edu-header  header-sticky header-transparent header-style-2 header-default ">
    <div class="row align-items-center">
        <div class="col-lg-4 col-xl-3 col-md-6 col-6">
            <div class="logo">
                <a href="{{route('home')}}">
                    <img class="logo-light" src="{{asset('frontEnd')}}/assets/images/image/logo/small-logo.png" alt="Site Logo">
                </a>
            </div>
        </div>
        <div class="col-lg-6 d-none d-xl-block">
            <nav class="mainmenu-nav d-none d-lg-block">
                <ul class="mainmenu">
                    ...
                    <li class=""><a href="{{route('front.course')}}">Courses</a>
                    <li class=""><a href="{{route('front.contact')}}">Contact</a>
                </ul>
            </nav>
        </div>
